<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 14: Add buttons to highlight authors -->
      <div style="margin: 10px 0">
        <button @click="highlightedAuthorId = austen?.id">Highlight Austen</button>
        <button @click="highlightedAuthorId = orwell?.id">Highlight Orwell</button>
        <button @click="highlightedAuthorId = agatha?.id">Highlight Agatha Christie</button>
        <button @click="highlightedAuthorId = null">Clear Highlight</button>
      </div>
      <ul>
        <li
...
const highlightedAuthorId = ref(null) // Activity 14: state for author highlight
...
// Activity 5: Find author by ID or name
const austen = computed(() => {
  return authors.find((author) => author.name === 'Jane Austen')
})

// Activity 14: Add Agatha Christie reference
const agatha = computed(() => {
  return authors.find((author) => author.name === 'Agatha Christie')
})
</script>
