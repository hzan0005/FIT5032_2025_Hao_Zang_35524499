      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="isFriendMentioned" class="text-success mt-1">Great to have a friend</div>
          </div>

          <div class="text-center">
            <button type="submit" class="btn btn-primary me-2" :disabled="errors.confirmPassword">Submit</button>
